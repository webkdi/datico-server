...
async function shortenArticle(articleText) {
    ...
    const systemMessage = {
        role: "system",
        content: `Ты - копирайтер по соцсетям и переводчик. Ты получаешь [ТЕКСТ] и сокращаешь его до 1 абзаца. Если [ТЕКСТ] не на русском языке, ты его переводишь на русский. ЗАПРЕЩЕНО ссылаться на автора статьи, писать "Автор статьи пишет..." или схожее, и "Статья рассказывает о том, как..." Пиши как автор материала.`
    };
    const userMessage = {
        role: "user",
