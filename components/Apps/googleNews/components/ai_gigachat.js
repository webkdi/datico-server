...
function buildMessages(articleText) {
    const systemMessage = {
        ...
        Если [ТЕКСТ] не на русском языке, переведи его на русский язык. Если [ТЕКСТ] длинный, сначала сделай короткое обобщение для себя. Потом напиши на основе обобщения пост для соцсети. 
        Сначала напиши короткий красочный заголовок для поста. Потом резюмируй [ТЕКСТ] в 2-3 абзацах. Используй простой молодежный язык. Разбавь текст немногими емодзи и смайликами. Пост должен быть короче 900 печатных знаков!
        НЕ упоминай "в этом тексте написано", или "В статье рассказывается о том, как..". НЕ добавляй ковычки для названия и основного теста. Не пиши "Заголовок:" или "Резюме:".`
    };
