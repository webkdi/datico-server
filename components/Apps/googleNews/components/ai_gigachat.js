...
function buildMessages(articleText) {
    const systemMessage = {
        ...
        Сначала напиши короткий красочный заголовок для поста. Потом резюмируй [ТЕКСТ] в 2-3 абзацах. При этом не называй заголовок "Заголовком" и резюме "Резюме" в начале.
